...
diagnosis_present <- diagnosis %>%
  select(-HBTQF, -DatasetQF, -DischargeCountQF, -DischargeRatesQF, -PatientCountQF, -PatientRatesQF, -HospitalResidentsCountQF, -HospitalResidentsRatesQF)
...
deprivation_present <- deprivation %>%
  select(-HBRQF, -DatasetQF, -DischargeCountQF, -DischargeRatesQF, -PatientCountQF, -PatientRatesQF, -HospitalResidentsCountQF, -HospitalResidentsRatesQF)
